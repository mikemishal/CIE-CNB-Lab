...
- [Download the small business onboarding readiness brief](https://raw.githubusercontent.com/mikemishal/CIE-CNB-Lab/main/small-business-onboarding-readiness-brief.docx)
- [Download the small business onboarding metrics workbook](https://raw.githubusercontent.com/mikemishal/CIE-CNB-Lab/main/small-business-onboarding-metrics.xlsx)

> **IMPORTANT:** Files downloaded from GitHub may open in Microsoft Office **Protected View** because they came from the internet. If this happens, select **Enable Editing**, then save the file to your OneDrive or another trusted location before using Copilot. If Windows still blocks the file, right-click the downloaded file, select **Properties**, check **Unblock**, and then select **Apply**.
